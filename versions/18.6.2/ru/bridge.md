...
- Рын. капитализация: `bridge:root=com.apple.StocksBridgeSettings`
- Рын. капитализация → В расширении на циферблатах отображается: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Рын. капитализация → Текущая цена: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Рын. капитализация → Изменения в пунктах: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Рын. капитализация → Изменения в процентах: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Рын. капитализация → Рын. капитализация: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Рын. капитализация → На циферблате Siri показана котировка:: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Рын. капитализация → Выбранная акция: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Рын. капитализация → Выбранная акция → Выбранная акция: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Основные → Экорежим: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Лимит хранилища: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Лимит хранилища → ПЛЕЙЛИСТЫ И АЛЬБОМЫ: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Лимит хранилища → Добавить музыку…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Уведомления о поворотах: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Уведомления о поворотах → Уведомления о поворотах: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Уведомления о поворотах → Автомобиль: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Уведомления о поворотах → Вождение с CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Уведомления о поворотах → Пешком: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Уведомления о поворотах → Велосипед: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Уведомления о поворотах → Показ навигации: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Уведомления о поворотах → Общественный транспорт: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Уведомления о поворотах → Сведения о сборке:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Макс. кол-во фото: `bridge:root=com.apple.mobileslideshow`