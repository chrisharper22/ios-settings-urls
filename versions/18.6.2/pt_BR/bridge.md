...
- Capitalização: `bridge:root=com.apple.StocksBridgeSettings`
- Capitalização → A Complicação do Mostrador Mostra: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Capitalização → Preço Atual: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Capitalização → Alteração de Pontos: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Capitalização → Alteração de Porcentagem: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Capitalização → Capitalização: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Capitalização → O Mostrador da Siri Mostra a Cotação para: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Capitalização → Ação Selecionada: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Capitalização → Ação Selecionada → Ação Selecionada: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Geral → Reserva de Energia: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limite: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limite → PLAYLISTS E ÁLBUNS: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limite → Adicionar Músicas…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Turn Alerts: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Turn Alerts → Alertas de Curva: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Turn Alerts → De carro: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Turn Alerts → De carro com CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Turn Alerts → A pé: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Turn Alerts → De Bicicleta: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Turn Alerts → Mostrar Navegação: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Turn Alerts → Transporte Público: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Turn Alerts → Informações da Compilação:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limite de Fotos: `bridge:root=com.apple.mobileslideshow`