...
- 市值: `bridge:root=com.apple.StocksBridgeSettings`
- 市值 → Clock Face Complication Shows: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- 市值 → Current Price: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 市值 → Points Change: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 市值 → Percentage Change: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- 市值 → Market Cap: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- 市值 → Siri Face Shows Quote For: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- 市值 → Selected Stock: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 市值 → Selected Stock → Selected Stock: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 转向时提醒: `bridge:root=com.apple.NanoMapsBridgeSettings`
- 转向时提醒 → Turn Alerts: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 转向时提醒 → Driving: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 转向时提醒 → Driving with CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 转向时提醒 → Walking: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 转向时提醒 → Cycling: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 转向时提醒 → Show Navigation: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 转向时提醒 → Transit: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 转向时提醒 → Build Info:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
