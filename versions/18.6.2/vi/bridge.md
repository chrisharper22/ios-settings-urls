...
- Giá trị vốn hóa: `bridge:root=com.apple.StocksBridgeSettings`
- Giá trị vốn hóa → Tổ hợp mặt đồng hồ hiển thị: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Giá trị vốn hóa → Giá hiện tại: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Giá trị vốn hóa → Thay đổi điểm: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Giá trị vốn hóa → Thay đổi phần trăm: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Giá trị vốn hóa → GT vốn hóa: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Giá trị vốn hóa → Mặt đồng hồ Siri hiển thị chào giá cho: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Giá trị vốn hóa → Chứng khoán được chọn: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Giá trị vốn hóa → Chứng khoán được chọn → Chứng khoán được chọn: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Cài đặt chung → Dự trữ năng lượng: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Giới hạn dung lượng: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Giới hạn dung lượng → PLAYLIST & ALBUM: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Giới hạn dung lượng → Thêm nhạc…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Cảnh báo rẽ: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Cảnh báo rẽ → Cảnh báo rẽ: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Cảnh báo rẽ → Lái xe: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Cảnh báo rẽ → Lái xe với CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Cảnh báo rẽ → Đi bộ: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Cảnh báo rẽ → Đi xe đạp: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Cảnh báo rẽ → Hiển thị dẫn đường: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Cảnh báo rẽ → PT công cộng: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Cảnh báo rẽ → Thông tin bản dựng:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Giới hạn Ảnh: `bridge:root=com.apple.mobileslideshow`