...
- Börsvärde: `bridge:root=com.apple.StocksBridgeSettings`
- Börsvärde → Urtavelskomplikation visar: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Börsvärde → Nuvarande pris: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Börsvärde → Prisändring: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Börsvärde → Procentändring: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Börsvärde → Börsvärde: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Börsvärde → Siri-urtavlan visar aktiekurs för: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Börsvärde → Vald aktie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Börsvärde → Vald aktie → Vald aktie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Allmänt → Strömsparläge: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Lagringsgräns: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Lagringsgräns → SPELLISTOR OCH ALBUM: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Lagringsgräns → Lägg till musik…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Svängsignaler: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Svängsignaler → Svängsignaler: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Svängsignaler → Köra: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Svängsignaler → Köra med CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Svängsignaler → Gång: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Svängsignaler → Cykling: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Svängsignaler → Visa navigation: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Svängsignaler → Kollektivt: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Svängsignaler → Bygginfo:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Bildbegränsning: `bridge:root=com.apple.mobileslideshow`