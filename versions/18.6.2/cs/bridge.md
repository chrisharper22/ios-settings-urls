...
- Tržní kapitalizace: `bridge:root=com.apple.StocksBridgeSettings`
- Tržní kapitalizace → Na ciferníku hodinek se zobrazí: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Tržní kapitalizace → Aktuální cena: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Tržní kapitalizace → Změna v bodech: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Tržní kapitalizace → Změna v procentech: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Tržní kapitalizace → Tržní kapitalizace: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Tržní kapitalizace → Na ciferníku Siri se zobrazuje kurz: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Tržní kapitalizace → Vybrané akcie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Tržní kapitalizace → Vybrané akcie → Vybrané akcie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Obecné → Rezerva: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limit úložiště: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limit úložiště → PLAYLISTY A ALBA: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limit úložiště → Přidat hudbu…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Upozornění na odbočení: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Upozornění na odbočení → Upozornění na odbočky: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Upozornění na odbočení → Autem: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Upozornění na odbočení → Řízení s CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Upozornění na odbočení → Pěšky: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Upozornění na odbočení → Kolo: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Upozornění na odbočení → Zobrazit navigaci: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Upozornění na odbočení → Veřejnou dopravou: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Upozornění na odbočení → Informace o sestavě:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limit fotek: `bridge:root=com.apple.mobileslideshow`