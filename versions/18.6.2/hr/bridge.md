...
- Tržišna kapitalizacija: `bridge:root=com.apple.StocksBridgeSettings`
- Tržišna kapitalizacija → Na brojčaniku sata prikazuje se: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Tržišna kapitalizacija → Trenutačna cijena: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Tržišna kapitalizacija → Promjena bodova: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Tržišna kapitalizacija → Promjena postotka: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Tržišna kapitalizacija → Tržišna kapitalizacija: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Tržišna kapitalizacija → Brojčanik Siri prikazuje kotaciju za: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Tržišna kapitalizacija → Odabrana dionica: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Tržišna kapitalizacija → Odabrana dionica → Odabrana dionica: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Općenito → Štednja energije: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Ograničenje memorije: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Ograničenje memorije → LISTE I ALBUMI: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Ograničenje memorije → Dodaj glazbu…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Obavijesti za skretanje: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Obavijesti za skretanje → Obavijesti za skretanje: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Obavijesti za skretanje → Vožnja: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Obavijesti za skretanje → Vožnja uz CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Obavijesti za skretanje → Hodanje: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Obavijesti za skretanje → Bicikliranje: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Obavijesti za skretanje → Prikaži navigaciju: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Obavijesti za skretanje → Javni prijevoz: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Obavijesti za skretanje → Informacije o međuverziji:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Ograničenje: `bridge:root=com.apple.mobileslideshow`