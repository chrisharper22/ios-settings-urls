...
- มูลค่าตลาด: `bridge:root=com.apple.StocksBridgeSettings`
- มูลค่าตลาด → กลไกหน้าปัดนาฬิกาแสดง: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- มูลค่าตลาด → ราคาปัจจุบัน: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- มูลค่าตลาด → การเปลี่ยนแปลงจุด: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- มูลค่าตลาด → เปอร์เซ็นต์การเปลี่ยนแปลง: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- มูลค่าตลาด → มูลค่าตลาด: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- มูลค่าตลาด → หน้าปัด Siri แสดงข้อมูลหุ้นสำหรับ: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- มูลค่าตลาด → หุ้นที่เลือก: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- มูลค่าตลาด → หุ้นที่เลือก → หุ้นที่เลือก: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- ทั่วไป → ประหยัดพลังงาน: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- ขีดจำกัดพื้นที่จัดเก็บข้อมูล: `bridge:root=com.apple.NanoMusicBridgeSettings`
- ขีดจำกัดพื้นที่จัดเก็บข้อมูล → เพลย์ลิสต์และอัลบั้ม: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- ขีดจำกัดพื้นที่จัดเก็บข้อมูล → เพิ่มเพลง…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- เปิด/ปิดการแจ้งเตือน: `bridge:root=com.apple.NanoMapsBridgeSettings`
- เปิด/ปิดการแจ้งเตือน → การแจ้งเตือนการเลี้ยว: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- เปิด/ปิดการแจ้งเตือน → ขับรถ: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- เปิด/ปิดการแจ้งเตือน → ขับรถด้วย CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- เปิด/ปิดการแจ้งเตือน → เดิน: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- เปิด/ปิดการแจ้งเตือน → ปั่นจักรยาน: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- เปิด/ปิดการแจ้งเตือน → แสดงการนำทาง: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- เปิด/ปิดการแจ้งเตือน → โดยสาร: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- เปิด/ปิดการแจ้งเตือน → ข้อมูลรุ่น:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- จำนวนรูปภาพสูงสุด: `bridge:root=com.apple.mobileslideshow`