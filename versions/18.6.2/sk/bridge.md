...
- Trhová kap.: `bridge:root=com.apple.StocksBridgeSettings`
- Trhová kap. → Na ciferníku sa zobrazí: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Trhová kap. → Aktuálna cena: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Trhová kap. → Zmena v bodoch: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Trhová kap. → Zmena v percentách: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Trhová kap. → Trhová kapitalizácia: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Trhová kap. → Na ciferníku Siri sa zobrazí: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Trhová kap. → Vybraná akcia: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Trhová kap. → Vybraná akcia → Vybraná akcia: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Všeobecné → Rezerva: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limit úložiska: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limit úložiska → PLAYLISTY A ALBUMY: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limit úložiska → Pridať hudbu…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Upozornenia na odbočenie: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Upozornenia na odbočenie → Upozornenia na odbočenie: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Upozornenia na odbočenie → Auto: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Upozornenia na odbočenie → Jazda autom s CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Upozornenia na odbočenie → Chôdza: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Upozornenia na odbočenie → Bicyklovanie: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Upozornenia na odbočenie → Zobraziť navigáciu: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Upozornenia na odbočenie → Verejná doprava: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Upozornenia na odbočenie → Build:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limit fotiek: `bridge:root=com.apple.mobileslideshow`