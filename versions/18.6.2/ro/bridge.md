...
- Dezactivați codul: `bridge:root=PASSCODE_ID`
- Dezactivați codul → Activați codul: `bridge:root=PASSCODE_ID#TOGGLE_PASSCODE_ID`
- Dezactivați codul → Schimbați codul: `bridge:root=PASSCODE_ID#CHANGE_PASSCODE_ID`
- Dezactivați codul → Cod de acces simplu: `bridge:root=PASSCODE_ID#SIMPLE_PASSCODE_SWITCH_ID`
- Dezactivați codul → Deblocare cu iPhone‑ul: `bridge:root=PASSCODE_ID#AUTO_UNLOCK_SWITCH_ID`
- Dezactivați codul → Ștergere date: `bridge:root=PASSCODE_ID#ERASE_DATA_SWITCH_ID`
- Dezactivați codul → Detectare încheietură: `bridge:root=PASSCODE_ID#WRIST_DETECTION_CELL_ID`
...
- Capitalizarea bursieră: `bridge:root=com.apple.StocksBridgeSettings`
- Capitalizarea bursieră → Complicațiile cadranului afișează: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Capitalizarea bursieră → Prețul curent: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Capitalizarea bursieră → Modificarea valorică: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Capitalizarea bursieră → Modificarea procentuală: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Capitalizarea bursieră → Capitalizare: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Capitalizarea bursieră → Cadranul Siri afișează cotația pentru: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Capitalizarea bursieră → Acțiunea bursieră selectată: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Capitalizarea bursieră → Acțiunea bursieră selectată → Acțiunea bursieră selectată: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- General → Rezervă de energie: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limită de stocare: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limită de stocare → LISTE DE REDARE ȘI ALBUME: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limită de stocare → Adăugați muzică…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Alerte viraj: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Alerte viraj → Alerte viraj: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Alerte viraj → Condus: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Alerte viraj → Condus cu CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Alerte viraj → Mers: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Alerte viraj → Pedalare: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Alerte viraj → Afișați navigarea: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Alerte viraj → Transport: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Alerte viraj → Informații build:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limită poze: `bridge:root=com.apple.mobileslideshow`