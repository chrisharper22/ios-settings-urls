...
- Market Cap: `bridge:root=com.apple.StocksBridgeSettings`
- Market Cap → Las complicaciones muestran: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Market Cap → Precio actual: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Market Cap → Cambio de puntos: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Market Cap → Porcentaje de cambio: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Market Cap → Capit. mercado: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Market Cap → La carátula de Siri muestra la cotización de: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Market Cap → Valor seleccionado: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Market Cap → Valor seleccionado → Valor seleccionado: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- General → Modo de ahorro: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Límite de almacenamiento: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Límite de almacenamiento → PLAYLISTS Y ÁLBUMES: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Límite de almacenamiento → Agregar música…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Mensajes → Default Replies: `bridge:root=com.apple.MessagesBridgeSettings&path=DEFAULT_REPLIES`
- Mensajes → Default Replies → Respuestas predeterminadas: `bridge:root=com.apple.MessagesBridgeSettings&path=DEFAULT_REPLIES#Default%20Replies`
- Mensajes → Default Replies → Respuestas inteligentes: `bridge:root=com.apple.MessagesBridgeSettings&path=DEFAULT_REPLIES#Smart%20Replies`
- Mensajes → Default Replies → Agregar respuesta…: `bridge:root=com.apple.MessagesBridgeSettings&path=DEFAULT_REPLIES#Add%20reply%E2%80%A6`
...
- Avisos de vuelta: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Avisos de vuelta → Avisos de vuelta: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Avisos de vuelta → En auto: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Avisos de vuelta → Navegación con CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Avisos de vuelta → A pie: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Avisos de vuelta → Bicicleta: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Avisos de vuelta → Mostrar la navegación: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Avisos de vuelta → Transporte: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Avisos de vuelta → Datos de la versión:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Photos Limit: `bridge:root=com.apple.mobileslideshow`