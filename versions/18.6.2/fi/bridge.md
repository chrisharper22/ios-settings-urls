...
- Markkina-arvo: `bridge:root=com.apple.StocksBridgeSettings`
- Markkina-arvo → Kellotaulun komplikaatiossa näkyy: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Markkina-arvo → Nykyinen hinta: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Markkina-arvo → Pistemuutos: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Markkina-arvo → Prosenttimuutos: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Markkina-arvo → Markkina-arvo: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Markkina-arvo → Siri-kellotaulu näyttää kurssin: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Markkina-arvo → Valittu osake: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Markkina-arvo → Valittu osake → Valittu osake: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Yleiset → Virransäästö: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Tallennusraja: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Tallennusraja → SOITTOLISTAT JA ALBUMIT: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Tallennusraja → Lisää musiikkia…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Käännösilmoitukset: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Käännösilmoitukset → Käännösilmoitukset: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Käännösilmoitukset → Ajo: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Käännösilmoitukset → Ajaminen CarPlaylla: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Käännösilmoitukset → Kävely: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Käännösilmoitukset → Pyöräily: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Käännösilmoitukset → Näytä navigointi: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Käännösilmoitukset → Julkiset: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Käännösilmoitukset → Buildin tiedot:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Kuvien rajoitus: `bridge:root=com.apple.mobileslideshow`