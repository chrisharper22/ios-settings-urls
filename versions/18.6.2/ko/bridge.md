...
- 시가 총액: `bridge:root=com.apple.StocksBridgeSettings`
- 시가 총액 → 시계 페이스 컴플리케이션에 표시: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- 시가 총액 → 현재가: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 시가 총액 → 포인트 변동: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 시가 총액 → 등락률: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- 시가 총액 → 시가 총액: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- 시가 총액 → Siri 페이스에 표시할 주식: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- 시가 총액 → 선택된 주식: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 시가 총액 → 선택된 주식 → 선택된 주식: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 일반 → 전원 절약: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- 저장 공간 제한: `bridge:root=com.apple.NanoMusicBridgeSettings`
- 저장 공간 제한 → 플레이리스트 및 앨범: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- 저장 공간 제한 → 음악 추가…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- 경로 알림: `bridge:root=com.apple.NanoMapsBridgeSettings`
- 경로 알림 → 경로 알림: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 경로 알림 → 운전: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 경로 알림 → CarPlay로 운전: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 경로 알림 → 도보: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 경로 알림 → 자전거: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 경로 알림 → 내비게이터 보기: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 경로 알림 → 대중교통: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 경로 알림 → 빌드 정보:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- 사진 제한: `bridge:root=com.apple.mobileslideshow`