...
- Marktkapital: `bridge:root=com.apple.StocksBridgeSettings`
- Marktkapital → Anzeige auf Zifferblatt­komplikation: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Marktkapital → Aktueller Kurs: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Marktkapital → Veränderung Punkte: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Marktkapital → Veränderung Prozent: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Marktkapital → Marktkapital: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Marktkapital → Siri-Zifferblatt zeigt Kurs für: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Marktkapital → Ausgewählte Aktie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Marktkapital → Ausgewählte Aktie → Ausgewählte Aktie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Allgemein → Gangreserve: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Speicherlimit: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Speicherlimit → PLAYLISTS & ALBEN: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Speicherlimit → Musik hinzufügen …: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Abbiegehinweise: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Abbiegehinweise → Abbiegehinweise: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Abbiegehinweise → Fahren: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Abbiegehinweise → Mit CarPlay fahren: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Abbiegehinweise → Gehen: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Abbiegehinweise → Radfahren: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Abbiegehinweise → Navigation anzeigen: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Abbiegehinweise → ÖPNV: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Abbiegehinweise → Build-Info:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Fotos-Limit: `bridge:root=com.apple.mobileslideshow`