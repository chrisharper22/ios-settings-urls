...
- Κεφαλαιοποίηση: `bridge:root=com.apple.StocksBridgeSettings`
- Κεφαλαιοποίηση → Η πολυπλοκότητα της πρόσοψης ρολογιού εμφανίζει: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Κεφαλαιοποίηση → Τρέχουσα τιμή: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Κεφαλαιοποίηση → Αλλαγή σε μονάδες: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Κεφαλαιοποίηση → Ποσοστιαία αλλαγή: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Κεφαλαιοποίηση → Κεφαλαιοποίηση: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Κεφαλαιοποίηση → Η πρόσοψη Siri εμφανίζει τιμή για: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Κεφαλαιοποίηση → Επιλεγμένη μετοχή: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Κεφαλαιοποίηση → Επιλεγμένη μετοχή → Επιλεγμένη μετοχή: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Γενικά → Εξοικονόμηση ενέργειας: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Όριο χώρου αποθήκευσης: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Όριο χώρου αποθήκευσης → ΛΙΣΤΕΣ ΚΑΙ ΑΛΜΠΟΥΜ: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Όριο χώρου αποθήκευσης → Προσθήκη μουσικής…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Ειδοποιήσεις στροφής: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Ειδοποιήσεις στροφής → Ειδοποιήσεις στροφής: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Ειδοποιήσεις στροφής → Οδήγηση: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Ειδοποιήσεις στροφής → Οδήγηση με CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Ειδοποιήσεις στροφής → Βάδισμα: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Ειδοποιήσεις στροφής → Ποδηλασία: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Ειδοποιήσεις στροφής → Εμφάνιση πλοήγησης: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Ειδοποιήσεις στροφής → ΜΜΜ: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Ειδοποιήσεις στροφής → Πληροφορίες έκδοσης:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Όριο φωτογραφιών: `bridge:root=com.apple.mobileslideshow`