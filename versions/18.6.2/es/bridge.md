...
- Capitalización de mercado: `bridge:root=com.apple.StocksBridgeSettings`
- Capitalización de mercado → La esfera del reloj muestra: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Capitalización de mercado → Precio actual: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Capitalización de mercado → Puntos de cambio: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Capitalización de mercado → Variación en porcentaje: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Capitalización de mercado → Capitalización de mercado: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Capitalización de mercado → La esfera de Siri muestra la cotización de: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Capitalización de mercado → Valor seleccionado: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Capitalización de mercado → Valor seleccionado → Valor seleccionado: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- General → Reserva de batería: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Límite de almacenamiento → Añadir música…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Avisos de giro: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Avisos de giro → Avisos de giro: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Avisos de giro → En coche: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Avisos de giro → En coche con CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Avisos de giro → A pie: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Avisos de giro → En bici: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Avisos de giro → Mostrar navegación: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Avisos de giro → Transporte público: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Avisos de giro → Datos de la compilación:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Límite para fotos: `bridge:root=com.apple.mobileslideshow`