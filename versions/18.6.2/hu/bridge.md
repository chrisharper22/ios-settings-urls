...
- Piaci tőke: `bridge:root=com.apple.StocksBridgeSettings`
- Piaci tőke → Az óraszámlap-komplikáció a következőt jeleníti meg: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Piaci tőke → Jelenlegi ár: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Piaci tőke → Változás pontokban: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Piaci tőke → Százalékos változás: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Piaci tőke → Piaci tőke: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Piaci tőke → A Siri-számlapon megjelenő árfolyam: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Piaci tőke → Kijelölt részvény: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Piaci tőke → Kijelölt részvény → Kijelölt részvény: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Általános → Energiatakarékos mód: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Tárhelykorlát: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Tárhelykorlát → LEJÁTSZÁSI LISTÁK ÉS ALBUMOK: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Tárhelykorlát → Zene hozzáadása…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Irányváltoztatási jelzések: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Irányváltoztatási jelzések → Irányváltoztatási jelzések: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Irányváltoztatási jelzések → Vezetés: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Irányváltoztatási jelzések → Vezetés a CarPlayjel: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Irányváltoztatási jelzések → Gyaloglás: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Irányváltoztatási jelzések → Biciklizés: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Irányváltoztatási jelzések → Navigáció megjelenítése: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Irányváltoztatási jelzések → Tömegközlekedés: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Irányváltoztatási jelzések → Buildinfó:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Fotók korlátja: `bridge:root=com.apple.mobileslideshow`