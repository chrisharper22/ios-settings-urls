...
- 市值 → 表盘复杂功能显示: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- 市值 → 当前价格: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 市值 → 点数变化: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 市值 → 百分比变化: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- 市值 → 市值: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- 市值 → Siri表盘显示的股票报价: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- 市值 → 所选股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 市值 → 所选股票 → 所选股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 通用 → 省电模式: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- 存储限制: `bridge:root=com.apple.NanoMusicBridgeSettings`
- 存储限制 → 播放列表与专辑: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- 存储限制 → 添加音乐…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- 转向时提醒 → 转向时提醒: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 转向时提醒 → 驾车: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 转向时提醒 → 开车时启用CarPlay车载: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 转向时提醒 → 步行: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 转向时提醒 → 骑车: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 转向时提醒 → 显示导航: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 转向时提醒 → 公交: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 转向时提醒 → 版号信息：: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- 照片上限: `bridge:root=com.apple.mobileslideshow`