...
- बाज़ार पूँजी: `bridge:root=com.apple.StocksBridgeSettings`
- बाज़ार पूँजी → घड़ी फ़ेस के कॉम्प्लिकेशन में प्रदर्शित होगा: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- बाज़ार पूँजी → वर्तमान क़ीमत: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- बाज़ार पूँजी → पॉइंट परिवर्तन: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- बाज़ार पूँजी → प्रतिशत परिवर्तन: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- बाज़ार पूँजी → बाज़ार पूँजी: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- बाज़ार पूँजी → Siri फ़ेस इसके लिए कोट दिखाता है: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- बाज़ार पूँजी → चयनित स्टॉक: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- बाज़ार पूँजी → चयनित स्टॉक → चयनित स्टॉक: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- सामान्य → पावर रिज़र्व: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- स्टोरेज सीमा: `bridge:root=com.apple.NanoMusicBridgeSettings`
- स्टोरेज सीमा → प्लेलिस्ट और ऐल्बम: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- स्टोरेज सीमा → संगीत जोड़ें…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- मोड़ अलर्ट: `bridge:root=com.apple.NanoMapsBridgeSettings`
- मोड़ अलर्ट → मोड़ अलर्ट: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- मोड़ अलर्ट → ड्राइविंग: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- मोड़ अलर्ट → CarPlay के साथ ड्राइविंग: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- मोड़ अलर्ट → पैदल: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- मोड़ अलर्ट → साइक्लिंग: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- मोड़ अलर्ट → नैविगेशन दिखाएँ: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- मोड़ अलर्ट → ट्रैंज़िट: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- मोड़ अलर्ट → बिल्ड जानकारी :: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- तस्वीरों की सीमा: `bridge:root=com.apple.mobileslideshow`