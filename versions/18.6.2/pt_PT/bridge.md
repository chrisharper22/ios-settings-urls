...
- Capitalização bolsista: `bridge:root=com.apple.StocksBridgeSettings`
- Capitalização bolsista → Visível no mostrador do relógio: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Capitalização bolsista → Preço atual: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Capitalização bolsista → Variação em pontos: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Capitalização bolsista → Variação percentual: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Capitalização bolsista → Cap. bolsista: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Capitalização bolsista → Cotação visível no mostrador Siri: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Capitalização bolsista → Ação selecionada: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Capitalização bolsista → Ação selecionada → Ação selecionada: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Geral → Poupança de energia: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limite de armazenamento: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limite de armazenamento → LISTAS E ÁLBUNS: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limite de armazenamento → Adicionar música…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Avisos de navegação: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Avisos de navegação → Avisos de navegação: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Avisos de navegação → De carro: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Avisos de navegação → De carro com CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Avisos de navegação → A pé: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Avisos de navegação → Bicicleta: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Avisos de navegação → Mostrar navegação: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Avisos de navegação → Transportes: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Avisos de navegação → Informação sobre a versão:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limite de fotografias: `bridge:root=com.apple.mobileslideshow`