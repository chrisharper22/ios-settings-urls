...
- رسملة السوق: `bridge:root=com.apple.StocksBridgeSettings`
- رسملة السوق → إضافة واجهة الساعة تعرض: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- رسملة السوق → السعر الحالي: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- رسملة السوق → التغير في النقاط: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- رسملة السوق → التغير في النسبة المئوية: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- رسملة السوق → رسملة السوق: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- رسملة السوق → واجهة Siri تعرض سعر: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- رسملة السوق → السهم المحدد: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- رسملة السوق → السهم المحدد → السهم المحدد: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- عام → توفير الطاقة: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- حد التخزين: `bridge:root=com.apple.NanoMusicBridgeSettings`
- حد التخزين → قوائم التشغيل والألبومات: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- حد التخزين → إضافة موسيقى…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- تنبيهات الاتجاه: `bridge:root=com.apple.NanoMapsBridgeSettings`
- تنبيهات الاتجاه → تنبيهات المنعطفات: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- تنبيهات الاتجاه → القيادة: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- تنبيهات الاتجاه → القيادة مع كاربلاي: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- تنبيهات الاتجاه → السير: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- تنبيهات الاتجاه → على الدراجة: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- تنبيهات الاتجاه → إظهار التنقل: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- تنبيهات الاتجاه → المواصلات: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- تنبيهات الاتجاه → معلومات البنية:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- حد الصور: `bridge:root=com.apple.mobileslideshow`