...
- 市值 → 錶面複雜功能顯示: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- 市值 → 目前價格: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 市值 → 漲跌: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 市值 → 漲跌幅: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- 市值 → 市值: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- 市值 → Siri錶面顯示的股票報價: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- 市值 → 所選的股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 市值 → 所選的股票 → 所選的股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 一般 → 省電模式: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- 儲存空間上限: `bridge:root=com.apple.NanoMusicBridgeSettings`
- 儲存空間上限 → 播放列表與專輯: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- 儲存空間上限 → 加入音樂⋯: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- 轉彎提示: `bridge:root=com.apple.NanoMapsBridgeSettings`
- 轉彎提示 → 轉彎提示: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 轉彎提示 → 開車: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 轉彎提示 → 開車時啟用CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 轉彎提示 → 步行: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 轉彎提示 → 自行車: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 轉彎提示 → 顯示導航: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 轉彎提示 → 大眾運輸: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 轉彎提示 → 版號資訊：: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
