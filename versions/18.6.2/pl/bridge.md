...
- Kapitalizacja: `bridge:root=com.apple.StocksBridgeSettings`
- Kapitalizacja → Komplikacja na tarczy wyświetla: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Kapitalizacja → Bieżący kurs: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Kapitalizacja → Zmiana punktowa: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Kapitalizacja → Zmiana procentowa: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Kapitalizacja → Kapitalizacja: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Kapitalizacja → Tarcza Siri wyświetla notowanie: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Kapitalizacja → Wybrane notowanie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Kapitalizacja → Wybrane notowanie → Wybrane notowanie: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Ogólne → Oszczędzaj energię: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limit pojemności: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limit pojemności → PLAYLISTY I ALBUMY: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limit pojemności → Dodaj muzykę…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Alerty manewrów: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Alerty manewrów → Alerty manewrów: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Alerty manewrów → Samochód: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Alerty manewrów → Samochód z CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Alerty manewrów → Pieszo: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Alerty manewrów → Jazda na rowerze: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Alerty manewrów → Pokaż nawigację: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Alerty manewrów → Transport publiczny: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Alerty manewrów → Kompilacja:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limit zdjęć: `bridge:root=com.apple.mobileslideshow`