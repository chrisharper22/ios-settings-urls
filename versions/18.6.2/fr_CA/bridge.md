...
- Cap. bours.: `bridge:root=com.apple.StocksBridgeSettings`
- Cap. bours. → Contenu de la complication du cadran: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Cap. bours. → Cours actuel: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Cap. bours. → Variation en points: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Cap. bours. → Variation en pour cent: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Cap. bours. → Capitalisation boursière: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Cap. bours. → Cours affiché sur le cadran Siri: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Cap. bours. → Action sélectionnée: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Cap. bours. → Action sélectionnée → Action sélectionnée: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Limite de stockage → LISTES DE LECTURE ET ALBUMS: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
...
- Activer les alertes: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Activer les alertes → Activer les alertes: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Activer les alertes → En voiture: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Activer les alertes → En voiture avec CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Activer les alertes → À pied: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Activer les alertes → À vélo: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Activer les alertes → Afficher l’écran de navigation: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Activer les alertes → Transport: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Activer les alertes → Infos de version :: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limite de photos: `bridge:root=com.apple.mobileslideshow`