...
- 市值 → 現時價格: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 市值 → 升跌: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 市值 → 升跌百分比: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
...
- 市值 → 所選股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 市值 → 所選股票 → 所選股票: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 一般 → 備用電量: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- 儲存空間上限 → 播放清單與專輯: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
...
- 轉向提示: `bridge:root=com.apple.NanoMapsBridgeSettings`
- 轉向提示 → 轉向提示: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 轉向提示 → 駕駛: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 轉向提示 → 開車時啟用CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 轉向提示 → 步行: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 轉向提示 → 踩單車: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 轉向提示 → 顯示導航: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 轉向提示 → 公共交通: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 轉向提示 → 版號資料：: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- 相片限制: `bridge:root=com.apple.mobileslideshow`