...
- Piyasa Değeri: `bridge:root=com.apple.StocksBridgeSettings`
- Piyasa Değeri → Saat Kadranı Komplikasyonu Şunu Gösterir: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Piyasa Değeri → Şu Anki Fiyat: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Piyasa Değeri → Puan Değişimi: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Piyasa Değeri → Yüzde Değişimi: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Piyasa Değeri → Piyasa Değeri: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Piyasa Değeri → Siri Kadranı Şu Verileri Gösterir: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Piyasa Değeri → Seçili Hisse Senedi: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Piyasa Değeri → Seçili Hisse Senedi → Seçili Hisse Senedi: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Genel → Güç Koruma: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Saklama Sınırı: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Saklama Sınırı → LİSTELER VE ALBÜMLER: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Saklama Sınırı → Müzik Ekle…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Dönüş Uyarıları: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Dönüş Uyarıları → Dönüş Uyarıları: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Dönüş Uyarıları → Araba: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Dönüş Uyarıları → CarPlay ile Yolculuk: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Dönüş Uyarıları → Yürüme: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Dönüş Uyarıları → Bisiklet: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Dönüş Uyarıları → Navigasyonu Göster: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Dönüş Uyarıları → Toplu Taşıma: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Dönüş Uyarıları → Build Bilgisi:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Fotoğraf Sınırı: `bridge:root=com.apple.mobileslideshow`