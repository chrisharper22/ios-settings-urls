...
- 時価総額: `bridge:root=com.apple.StocksBridgeSettings`
- 時価総額 → 文字盤のコンプリケーションに表示: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- 時価総額 → 現在の株価: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- 時価総額 → 値動き: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- 時価総額 → 値動きの割合: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- 時価総額 → 時価総額: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- 時価総額 → Siri文字盤に株価を表示する銘柄: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- 時価総額 → 選択された銘柄: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- 時価総額 → 選択された銘柄 → 選択された銘柄: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- 一般 → 省電力モード: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- 容量制限: `bridge:root=com.apple.NanoMusicBridgeSettings`
- 容量制限 → プレイリストとアルバム: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- 容量制限 → ミュージックを追加…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- 案内を通知: `bridge:root=com.apple.NanoMapsBridgeSettings`
- 案内を通知 → 案内を通知: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- 案内を通知 → 車: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- 案内を通知 → 車（CarPlay付き）: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- 案内を通知 → 徒歩: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- 案内を通知 → サイクリング: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- 案内を通知 → ナビゲーションを表示: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- 案内を通知 → 交通機関: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- 案内を通知 → ビルド情報:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- 写真の上限: `bridge:root=com.apple.mobileslideshow`