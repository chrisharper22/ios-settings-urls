...
- La capitalisation boursière: `bridge:root=com.apple.StocksBridgeSettings`
- La capitalisation boursière → La complication du cadran affiche: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- La capitalisation boursière → Le cours actuel: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- La capitalisation boursière → L’évolution des points: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- La capitalisation boursière → L’évolution du pourcentage: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- La capitalisation boursière → La capitalisation boursière: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- La capitalisation boursière → Cours affiché par le cadran Siri: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- La capitalisation boursière → Action sélectionnée: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- La capitalisation boursière → Action sélectionnée → Action sélectionnée: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Général → Mode Réserve: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Limite de stockage: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Limite de stockage → PLAYLISTS ET ALBUMS: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Limite de stockage → Ajouter de la musique…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Indications: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Indications → Indications: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Indications → En voiture: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Indications → Conduite avec CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Indications → À pied: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Indications → À vélo: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Indications → Afficher la navigation: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Indications → Transports: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Indications → Informations de version :: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Limite: `bridge:root=com.apple.mobileslideshow`