...
- Пазарна капитализация: `bridge:root=com.apple.StocksBridgeSettings`
- Пазарна капитализация → Добавката за циферблата на часовника показва: `bridge:root=com.apple.StocksBridgeSettings#Clock%20Face%20Complication%20Shows`
- Пазарна капитализация → Настояща цена: `bridge:root=com.apple.StocksBridgeSettings#Current%20Price`
- Пазарна капитализация → Изменение в пунктове: `bridge:root=com.apple.StocksBridgeSettings#Points%20Change`
- Пазарна капитализация → Изменение в проценти: `bridge:root=com.apple.StocksBridgeSettings#Percentage%20Change`
- Пазарна капитализация → Пазарна капитализация: `bridge:root=com.apple.StocksBridgeSettings#Market%20Cap`
- Пазарна капитализация → Циферблатът Siri показва котировка за: `bridge:root=com.apple.StocksBridgeSettings#Siri%20Face%20Shows%20Quote%20For`
- Пазарна капитализация → Избрана акция: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock`
- Пазарна капитализация → Избрана акция → Избрана акция: `bridge:root=com.apple.StocksBridgeSettings&path=Selected%20Stock#Selected%20Stock`
...
- Основни → Пестене на батерия: `bridge:root=GENERAL_LINK&path=USAGE_LINK`
...
- Лимит на пространство за съхранение: `bridge:root=com.apple.NanoMusicBridgeSettings`
- Лимит на пространство за съхранение → СПИСЪЦИ С ПЕСНИ И АЛБУМИ: `bridge:root=com.apple.NanoMusicBridgeSettings#PLAYLISTS%20&%20ALBUMS`
- Лимит на пространство за съхранение → Добави музика…: `bridge:root=com.apple.NanoMusicBridgeSettings#Add%20Music%E2%80%A6`
...
- Предупреждения за завой: `bridge:root=com.apple.NanoMapsBridgeSettings`
- Предупреждения за завой → Предупреждения за завой: `bridge:root=com.apple.NanoMapsBridgeSettings#Turn%20Alerts`
- Предупреждения за завой → Шофиране: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving`
- Предупреждения за завой → Шофиране с CarPlay: `bridge:root=com.apple.NanoMapsBridgeSettings#Driving%20with%20CarPlay`
- Предупреждения за завой → Ходене пеша: `bridge:root=com.apple.NanoMapsBridgeSettings#Walking`
- Предупреждения за завой → Колоездене: `bridge:root=com.apple.NanoMapsBridgeSettings#Cycling`
- Предупреждения за завой → Покажи навигация: `bridge:root=com.apple.NanoMapsBridgeSettings#Show%20Navigation`
- Предупреждения за завой → Обществен транспорт: `bridge:root=com.apple.NanoMapsBridgeSettings#Transit`
- Предупреждения за завой → Информация за компилация:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`
...
- Лимит за снимки: `bridge:root=com.apple.mobileslideshow`